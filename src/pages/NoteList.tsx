...
export function NoteList({ availableTags, notes, onDeleteTag, onUpdateTag }: NoteListProps) {
    ...
    const [editTagsModalIsOpen, setEditTagsIsOpen] = useState(false)
    ...
    return (
        <>
            <Row className="align-items-center mb-4">
                ...
                <Col xs="auto">
                    <Stack gap={2} direction="horizontal">
                        ...
                        <Button variant="secondary" onClick={() => setEditTagsIsOpen(true)}>Edit Tags</Button>
                    </Stack>
                </Col>
            </Row>
            <Form>
            ...
            <Row xs={1} sm={2} lg={3} xl={4} class="g-3">
